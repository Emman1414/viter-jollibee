  ...
  return (
    <>
      ...
      <div className="grid grid-rows-[auto,_1fr,_auto] min-h-[calc(100vh-200px)]">
        ...
        <div className="flex p-1 px-3 justify-between items-center bg-primary text-white p-1">
          ...
          >
            {cartData.length > 0 && (
              <span className="absolute -left-2 -top-2 text-[8] bg-white text-primary rounded-full size-[20px] font-bold grid place-content-center">
                {cartData.length}
              </span>
            )}
            View Cart
